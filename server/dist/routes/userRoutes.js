...
const userController_1 = __importStar(require("../controlers/userController"));
...
router.post('/recomendaciones', userController_1.ObtenerRecomendaciones);
router.get('/obtener-datos/:usuario_id', userController_1.default);
